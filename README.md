...
- **Interactive Global Map**: Visualizing trade routes and supply chains.
- **Admin Dashboard**: Comprehensive management interface for content, messages, and statistics.
- **Responsive Design**: Fully optimized for mobile, tablet, and desktop.
- **Light/Dark Mode**: Professional light theme for the admin panel.
...
```bash
cd backend
pip install -r requirements.txt # Note: Create this file if missing
python app.py
```
